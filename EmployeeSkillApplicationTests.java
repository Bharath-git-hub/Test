...
public class EmployeeSkillApplicationTests {
	...
	public void excelDownload() {
		...
		emp.setEmpname("Test Name");
		emp.setEmployeeID(1);
		new EmployeeDataExcelExport();
		emailService.sendSimpleMail("Test@gmail.com");
		verify(emailService).sendSimpleMail(Mockito.anyString());
		verifyNoMoreInteractions(Mockito.mock(EmployeeDataExcelExport.class));
	}
	...
	public void pdfDownload() {
		...
		emp.setEmpname("Test Name");
		emp.setEmployeeID(1);
		new EmployeeDataPdfExport();
		emailService.sendSimpleMail("Test@gmail.com");
		verify(emailService).sendSimpleMail(Mockito.anyString());
		verifyNoMoreInteractions(Mockito.mock(EmployeeDataPdfExport.class));
	}
